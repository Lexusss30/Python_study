...
lab_text_1 = Label(text="Привет,котёночек" , bg="#f40dd1" , font=("Segoe Print" , 18) , fg="#b2f704")
lab_text_1.place(x=280 , y = 90 , width= 300 , height=50)



lab_text_2 = Label(text="Ты самая лучшая", font=("Ink Free" , 15))
...
def fun_1():
    print("ok")
    lab_text_2.config(bg="#ffd084" , text="Я тебя люблю малышка")
